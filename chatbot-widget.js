...
function startConversation() {
    fetch('https://chatbot-for-the-meadows-early-learning-center-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
   ...
   // sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-the-meadows-early-learning-center-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzrVMKiYRGtFALkDZxzpea3e7PppdGAdUwNy_w4RaWFSHc831j9uBaP2_AQQClYAcbM/exec';
